Welcome to pyGtkFit, an example of creating a
cross-platform curve and surface fitting application 
using pyGtk and the pyeq3 fitting library.
...
You are now curve and surface fitting data using pyGtk!
