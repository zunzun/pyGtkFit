...
if __name__ == "__main__":
    ...
    pickledEquationFileName = 'pickledEquationFile'
    ...
    nbTopLevel = Gtk.Notebook() # the "main" notebook at application top level
    ...
    # NOTE: at the end of this file is added a Gtk.TextView list of all equations
